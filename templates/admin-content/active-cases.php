...
<div id="active-case-content-admin" class="content-section">
    <div id="active-cases-header" class="flex justify-between items-center">
        <div id="active-cases-header-left">
            <h3 style="font-size: 24px; font-weight: 600; text-transform: capitalize; margin-bottom: 5px;">Active Cases</h3>
            <p style="font-size: 16px; font-weight: 400; color: #00000070; text-transform: capitalize;">Manage and track active cases here.</p>
        </div>
    </div>

    <!-- Case List -->
    <div id="active-case-list-container" class="mt-4 space-y-4">
        <?php
