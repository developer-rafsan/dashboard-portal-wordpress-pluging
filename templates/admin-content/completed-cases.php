...
<div id="completed-case-content-admin" class="content-section">
    <div id="completed-cases-header" class="flex justify-between items-center">
        <div id="completed-cases-header-left">
            <h3 style="font-size: 24px; font-weight: 600; text-transform: capitalize; margin-bottom: 5px;">Completed Cases</h3>
            <p style="font-size: 16px; font-weight: 400; color: #00000070; text-transform: capitalize;">View all completed cases here.</p>
        </div>
    </div>

    <!-- Case List -->
    <div id="completed-case-list-container" class="mt-4 space-y-4">
        <?php
        ...
        <div class="flex justify-between items-center bg-white py-4 px-6 rounded-md border border-gray-200 case-card">
            <div>
                ...
                <ul class="flex items-center gap-2 mt-4">
                    ...
                    <li>
                        <span
                            class="bg-green-100 text-green-700 text-opacity-80 text-sm px-2 py-1 rounded-full cursor-pointer capitalize">
